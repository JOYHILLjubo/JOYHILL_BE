...
public class CommunityPrayerController {
    ...
    @PostMapping
    public BaseResponse<Map<String, Object>> create(@RequestBody Map<String, String> body) {
        return BaseResponse.success(communityPrayerService.create(body.get("content")));
    }
}
